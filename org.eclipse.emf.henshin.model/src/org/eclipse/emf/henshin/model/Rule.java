 ...
 *   <li>{@link org.eclipse.emf.henshin.model.Rule#isLiftedRule <em>Lifted Rule</em>}</li>
 * </ul>
 *
...
public interface Rule extends Unit {
	...
	/**
	 * Returns the value of the '<em><b>Lifted Rule</b></em>' attribute.
	 * The default value is <code>"true"</code>.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Lifted Rule</em>' attribute.
	 * @see #setLiftedRule(boolean)
	 * @see org.eclipse.emf.henshin.model.HenshinPackage#getRule_LiftedRule()
	 * @model default="true" ordered="false"
	 * @generated
	 */
	boolean isLiftedRule();

	/**
	 * Sets the value of the '{@link org.eclipse.emf.henshin.model.Rule#isLiftedRule <em>Lifted Rule</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Lifted Rule</em>' attribute.
	 * @see #isLiftedRule()
	 * @generated
	 */
	void setLiftedRule(boolean value);
