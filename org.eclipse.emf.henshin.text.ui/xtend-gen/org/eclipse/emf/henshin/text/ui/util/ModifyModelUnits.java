...
public class ModifyModelUnits {
  ...
  public ParameterType getParameterType(final ParameterType type) {
    ...
    if (_notEquals) {
      ...
      if (Objects.equal(_literal, "EBigDecimal")) {
        _matched=true;
        value = Type.EBIG_DECIMAL;
      }
      if (!_matched) {
        if (Objects.equal(_literal, "EBigInteger")) {
          _matched=true;
          value = Type.EBIG_INTEGER;
        }
      }
      if (!_matched) {
        if (Objects.equal(_literal, "EBoolean")) {
          _matched=true;
          value = Type.EBOOLEAN;
        }
      }
      if (!_matched) {
        if (Objects.equal(_literal, "EBooleanObject")) {
          _matched=true;
          value = Type.EBOOLEAN_OBJECT;
        }
      }
      if (!_matched) {
        if (Objects.equal(_literal, "EByte")) {
          _matched=true;
          value = Type.EBYTE;
        }
      }
      if (!_matched) {
        if (Objects.equal(_literal, "EByteArray")) {
          _matched=true;
          value = Type.EBYTE_ARRAY;
        }
      }
      if (!_matched) {
        if (Objects.equal(_literal, "EByteObject")) {
          _matched=true;
          value = Type.EBYTE_OBJECT;
        }
      }
      if (!_matched) {
        if (Objects.equal(_literal, "EChar")) {
          _matched=true;
          value = Type.ECHAR;
        }
      }
      if (!_matched) {
        if (Objects.equal(_literal, "ECharacterObject")) {
          _matched=true;
          value = Type.ECHARACTER_OBJECT;
        }
      }
      if (!_matched) {
        if (Objects.equal(_literal, "EDate")) {
          _matched=true;
          value = Type.EDATE;
        }
      }
      if (!_matched) {
        if (Objects.equal(_literal, "EDiagnosticChain")) {
          _matched=true;
          value = Type.EDIAGNOSTIC_CHAIN;
        }
      }
      if (!_matched) {
        if (Objects.equal(_literal, "EDouble")) {
          _matched=true;
          value = Type.EDOUBLE;
        }
      }
      if (!_matched) {
        if (Objects.equal(_literal, "EDoubleObject")) {
          _matched=true;
          value = Type.EDOUBLE_OBJECT;
        }
      }
      if (!_matched) {
        if (Objects.equal(_literal, "EEList")) {
          _matched=true;
          value = Type.EE_LIST;
        }
      }
      if (!_matched) {
        if (Objects.equal(_literal, "EEnumerator")) {
          _matched=true;
          value = Type.EENUMERATOR;
        }
      }
      if (!_matched) {
        if (Objects.equal(_literal, "EFeatureMap")) {
          _matched=true;
          value = Type.EFEATURE_MAP;
        }
      }
      if (!_matched) {
        if (Objects.equal(_literal, "EFeatureMapEntry")) {
          _matched=true;
          value = Type.EFEATURE_MAP_ENTRY;
        }
      }
      if (!_matched) {
        if (Objects.equal(_literal, "EFloat")) {
          _matched=true;
          value = Type.EFLOAT;
        }
      }
      if (!_matched) {
        if (Objects.equal(_literal, "EFloatObject")) {
          _matched=true;
          value = Type.EFLOAT_OBJECT;
        }
      }
      if (!_matched) {
        if (Objects.equal(_literal, "EInt")) {
          _matched=true;
          value = Type.EINT;
        }
      }
      if (!_matched) {
        if (Objects.equal(_literal, "EIntegerObject")) {
          _matched=true;
          value = Type.EINTEGER_OBJECT;
        }
      }
      if (!_matched) {
        if (Objects.equal(_literal, "ETreeIterator")) {
          _matched=true;
          value = Type.ETREE_ITERATOR;
        }
      }
      if (!_matched) {
        if (Objects.equal(_literal, "EInvocationTargetException")) {
          _matched=true;
          value = Type.EINVOCATION_TARGET_EXCEPTION;
        }
      }
      if (!_matched) {
        if (Objects.equal(_literal, "EJavaClass")) {
          _matched=true;
          value = Type.EJAVA_CLASS;
        }
      }
      if (!_matched) {
        if (Objects.equal(_literal, "EJavaObject")) {
          _matched=true;
          value = Type.EJAVA_OBJECT;
        }
      }
      if (!_matched) {
        if (Objects.equal(_literal, "ELong")) {
          _matched=true;
          value = Type.ELONG;
        }
      }
      if (!_matched) {
        if (Objects.equal(_literal, "ELongObject")) {
          _matched=true;
          value = Type.ELONG_OBJECT;
        }
      }
      if (!_matched) {
        if (Objects.equal(_literal, "EMap")) {
          _matched=true;
          value = Type.EMAP;
        }
      }
      if (!_matched) {
        if (Objects.equal(_literal, "EResource")) {
          _matched=true;
          value = Type.ERESOURCE;
        }
      }
      if (!_matched) {
        if (Objects.equal(_literal, "EResourceSet")) {
          _matched=true;
          value = Type.ERESOURCE_SET;
        }
      }
      if (!_matched) {
        if (Objects.equal(_literal, "EShort")) {
          _matched=true;
          value = Type.ESHORT;
        }
      }
      if (!_matched) {
        if (Objects.equal(_literal, "EShortObject")) {
          _matched=true;
          value = Type.ESHORT_OBJECT;
        }
      }
      if (!_matched) {
        if (Objects.equal(_literal, "EString")) {
          _matched=true;
          value = Type.ESTRING;
        }
      }
